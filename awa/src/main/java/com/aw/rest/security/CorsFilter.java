...
public class CorsFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
		...
		if (request.getHeader("Access-Control-Request-Method") != null && "OPTIONS".equalsIgnoreCase(request.getMethod().trim())) {
	...
	/*
			...
			.allowedHeaders("Origin", "Content-Type", "Authorization", "X-CSRF-Token", "X-Requested-With", 
							"Accept", "Accept-Version", "Content-Length", "Content-MD5",  "Date", "X-Api-Version", "X-File-Name")
