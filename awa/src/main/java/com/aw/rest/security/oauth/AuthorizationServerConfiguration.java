 ...
 * http://docs.spring.io/spring-security/site/docs/current/reference/htmlsingle/#tutorial-sample
 * 
 *
 */
@Configuration
...
public class AuthorizationServerConfiguration extends AuthorizationServerConfigurerAdapter {
	...
	static final Logger log = LoggerFactory.getLogger(AuthorizationServerConfiguration.class);
